...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $dateFormat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($format); ?>"
                        ...
                        <?php echo e($format); ?> (<?php echo e($dateObject->translatedFormat($format)); ?>)
                    </option>
...
<?php $component->withAttributes([]); ?>
                <option value="h:i A" <?php if(companyOrGlobalSetting()->time_format == 'h:i A'): ?> selected <?php endif; ?>>
                    12 Hour (<?php echo e(now(companyOrGlobalSetting()->timezone)->translatedFormat('h:i A')); ?>)
                </option>
                <option value="h:i a" <?php if(companyOrGlobalSetting()->time_format == 'h:i a'): ?> selected <?php endif; ?>>
                    12 Hour (<?php echo e(now(companyOrGlobalSetting()->timezone)->translatedFormat('h:i a')); ?>)
                </option>
                <option value="H:i" <?php if(companyOrGlobalSetting()->time_format == 'H:i'): ?> selected <?php endif; ?>>
                    24 Hour (<?php echo e(now(companyOrGlobalSetting()->timezone)->translatedFormat('H:i')); ?>)
                </option>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal67cd5dc9866c6185ad92d933c387fa86)): ?>
...
<?php $component->withAttributes([]); ?>
                <?php $__currentLoopData = $languageSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php echo e(companyOrGlobalSetting()->locale == $language->language_code ? 'selected' : ''); ?>
...
<?php endif; ?>
            ...
            <?php if(isWorksuiteSaas()): ?>
                <div class="col-lg-4 mt-lg-3">
                    <?php if (isset($component)) { $__componentOriginal9c5d7e5b2e4b8b16cfa941b5e69189f3 = $component; } ?>
<?php $component = App\View\Components\Forms\Checkbox::resolve(['checked' => global_setting()->company_need_approval,'fieldLabel' => __('superadmin.superadmin.needApproval'),'fieldName' => 'company_need_approval','popover' => __('superadmin.superadmin.needApprovalInfo'),'fieldId' => 'company_need_approval'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Checkbox::class))->getConstructor()): ?>
...
<?php endif; ?>
                ...
                <div class="col-lg-4 mt-lg-3">
                    <?php if (isset($component)) { $__componentOriginal9c5d7e5b2e4b8b16cfa941b5e69189f3 = $component; } ?>
<?php $component = App\View\Components\Forms\Checkbox::resolve(['checked' => global_setting()->email_verification,'fieldLabel' => __('superadmin.emailVerification'),'fieldName' => 'email_verification','popover' => __('superadmin.emailVerificationEnableDisable'),'fieldId' => 'email_verification'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.checkbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Checkbox::class))->getConstructor()): ?>
...
<script>
    ...
    $('body').on('click', '#save-app-settings-form', function () {
        const url = "<?php echo e(route('app-settings.update', [companyOrGlobalSetting()->id])); ?>?page=app-setting";
...
<?php /**PATH C:\laragon\www\worksuite\resources\views/app-settings/ajax/app-setting.blade.php ENDPATH**/ ?>