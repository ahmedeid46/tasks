...
<?php $component = App\View\Components\Forms\LinkPrimary::resolve(['link' => route('superadmin.superadmin.create'),'icon' => 'plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 float-left openRightModal']); ?>
                    ...
                    <?php echo app('translator')->get('superadmin.menu.superAdmin'); ?>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('superadmin.superadmin.destroy', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\worksuite\resources\views/super-admin/super-admin/index.blade.php ENDPATH**/ ?>