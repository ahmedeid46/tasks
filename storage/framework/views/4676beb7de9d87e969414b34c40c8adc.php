        ...
        <div class="row">
            <div class="col-12">
                <div class="sec-title mb-5">
                    <h3><?php echo e($trFrontDetail->testimonial_title); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\worksuite\resources\views/super-admin/saas/section/testimonial.blade.php ENDPATH**/ ?>