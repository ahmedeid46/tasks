...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('superadmin.dashboard.recentRegisteredCompanies'),'padding' => 'false','otherClasses' => 'h-200'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'border-0 mb-0 admin-dash-table table-hover']); ?>
             ...
             <?php $__env->slot('thead', null, []); ?> 
                ...
                <th><?php echo app('translator')->get('superadmin.packages.packages'); ?></th>
                <th><?php echo app('translator')->get('app.date'); ?></th>
             <?php $__env->endSlot(); ?>

            <?php $__empty_1 = true; $__currentLoopData = $recentRegisteredCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php endif; ?>
                    ...
                    <td>
                        <?php echo e(($item->package ? $item->package->name : '--') . ' (' . $item->package_type . ')'); ?>

                    </td>
                    <td>
                        <?php echo e($item->created_at->timezone(global_setting()->timezone)->translatedFormat(global_setting()->date_format.' '.global_setting()->time_format)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\worksuite\resources\views/super-admin/dashboard/recent-registered-companies.blade.php ENDPATH**/ ?>