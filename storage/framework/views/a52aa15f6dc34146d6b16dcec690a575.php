...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('superadmin.dashboard.recentSubscriptions'),'padding' => 'false','otherClasses' => 'h-200'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'border-0 mb-0 admin-dash-table table-hover']); ?>
             ...
             <?php $__env->slot('thead', null, []); ?> 
                ...
                <th><?php echo app('translator')->get('superadmin.subscriptionDate'); ?></th>
             <?php $__env->endSlot(); ?>

            <?php $__empty_1 = true; $__currentLoopData = $recentSubscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php endif; ?>
                    ...
                    <td>
                        <?php echo e($item->subscription_updated_at->translatedFormat(global_setting()->date_format)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\worksuite\resources\views/super-admin/dashboard/recent-subscriptions.blade.php ENDPATH**/ ?>