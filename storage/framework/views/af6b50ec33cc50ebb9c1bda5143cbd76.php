...
<?php $component = App\View\Components\Cards\Data::resolve(['title' => __('superadmin.dashboard.recentLicenceExpiredCompanies'),'padding' => 'false','otherClasses' => 'h-200'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'border-0 mb-0 admin-dash-table table-hover']); ?>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $recentLicenceExpiredCompanies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php endif; ?>
                    ...
                    <td>
                        <?php echo e($item->created_at->translatedFormat(global_setting()->date_format)); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\worksuite\resources\views/super-admin/dashboard/recent-license-expired.blade.php ENDPATH**/ ?>