...
unset($__errorArgs, $__bag); ?>"
            ...
            <?php if($socialAuthSettings->social_auth_enable && !$errors->has('g-recaptcha-response')): ?>
                ...
                <?php if(isWorksuiteSaas() && !module_enabled('Subdomain')): ?>
                    <?php if($globalSetting->enable_register == true): ?>
                        <a href="<?php echo e(route('front.signup.index')); ?>" id="signup-customer"
                        class="btn-secondary f-w-500 rounded w-100 height-50 f-15 mt-3">
            ...
            <div id="password-section"
                 <?php if($socialAuthSettings->social_auth_enable && !$errors->has('g-recaptcha-response')): ?> class="d-none" <?php endif; ?>>
                <div class="form-group text-left">
...
<?php endif; ?>
         ...
         <?php $__env->slot('outsideLoginBox', null, []); ?> 
            <?php if(isWorksuiteSaas() && !$globalSetting->frontend_disable  ): ?>
                ...
                <p class="my-2 f-12"><a
                        href="<?php echo e(module_enabled('Subdomain') && !is_null(config('app.main_application_subdomain'))?'//'.config('app.main_application_subdomain'):'//'.getDomain()); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\worksuite\resources\views/auth/login.blade.php ENDPATH**/ ?>