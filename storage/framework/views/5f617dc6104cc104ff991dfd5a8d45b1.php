...
<aside class="<?php echo e(!user()->dark_theme ? 'sidebar-' . $appTheme->sidebar_theme : ''); ?>">
    ...
    <div class="main-sidebar" id="mobile_menu_collapse">
            ...
            <div class="dropdown-menu dropdown-menu-right sidebar-brand-dropdown ml-3"
                ...
                <div class="d-flex justify-content-between align-items-center profile-box">
                    ...
                    <?php if(user()->is_superadmin): ?>
                        <a href="<?php echo e(route('superadmin.settings.super-admin-profile.index')); ?>"
                           data-toggle="tooltip"
                ...
                <!-- WORKSUITESAAS -->
                <?php echo $__env->make('super-admin.sections.choose-company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="sidebar-menu <?php echo e(user()->dark_theme ? 'bg-dark' : ''); ?>" id="sideMenuScroll">
            <!-- WORKSUITESAAS -->
            <?php if(user()->is_superadmin): ?>
                <?php echo $__env->make('super-admin.sections.super-admin-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
    ...
    <div
        ...
        <div class="d-flex align-items-center">
            <p class="mb-0 text-dark-grey px-1 py-0 rounded f-10">v<?php echo e(File::get('version.txt')); ?></p>
            <?php if(isWorksuiteSaas()): ?>
                <?php if(in_array('admin', user_roles()) ): ?>
                    <p class="mb-0"><a href="<?php echo e(route('superadmin.faqs.index')); ?>" class="text-secondary ml-2 f-15" data-toggle="tooltip" data-original-title="<?php echo e(__('superadmin.contactSupport')); ?>"><i class="fa fa-question-circle"></i></a></p>
                <?php elseif(user()->is_superadmin): ?>
                    <p class="mb-0"><a target="_blank" data-toggle="tooltip" data-original-title="<?php echo e(__('superadmin.VisitFrontWebsite')); ?>" href="<?php echo e(route('front.home')); ?>" class="text-secondary ml-2 f-15"><i class="fa fa-external-link-alt"></i></a></p>
                 <?php endif; ?>
             <?php endif; ?>
...
<?php /**PATH C:\laragon\www\worksuite\resources\views/sections/sidebar.blade.php ENDPATH**/ ?>